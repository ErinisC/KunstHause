...
<script>
    ...
    const cardnumber = document.getElementById('credit-number');
    const expirationdate = document.getElementById('valid-date');
    const securitycode = document.getElementById('security-number');
