    ...
    <div class="container">
        <div class="row signinbg col-12">
            ...
            <form name="b2b_form" method="post" onsubmit="checkForm();return false;" novalidate>
                <div class="ogzcard">
                    <div class="picture">
                        <img class="eventimg" src="" width="100%" height="225" style="border:0">
                    </div>
                    ...
                    <input id="picture" class="pictureadd" ref={fileInput} accept="image/jpeg,image/png" type="file" onChange={handleImageChange}>
