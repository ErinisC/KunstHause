                                ...
                                <div class="wrap mt-1">
                                    <div class="card-body p-0 w-100">
                                        <div class="card-info position-relative p-3">
                                            <div class="event-name mb-3"><?= $rows[$cardIndex]['event_name'] ?></div>

                                            <div class="event-location mb-2">
                                                <i class="fas fa-map-marker-alt"></i>
                                                <?= $rows[$cardIndex]['location'] ?>
                                            </div>
                                        ...
                                        <!-- 價格按鈕加Modal的彈跳窗格 -->
                                        <a href="javascript:showProductModal(<?= $rows[$cardIndex]['sid'] ?>)" class="card-price py-3 w-100">
