    ...
    <div class="container">
        <div class="row signinbg col-12">
            ...
            <div class="inputform col-xl-8 col-12">
                ...
                <input class="inputbox" type="text" placeholder="(02)-0003-1234">
                <input class="inputbox" type="text" placeholder="123">
                <p class="trouble2">X 必填資訊未填寫完整</p>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content pt-3 mx-auto">
                        ...
                        <div class="modal-footer mx-auto mt-2">
                            <button type="button" class="closebutton btn btn-secondary" data-dismiss="modal" style="background-color: #fff" onclick="location.href='3_B2B-member-profile.php'">關閉視窗</button>
                        </div>
