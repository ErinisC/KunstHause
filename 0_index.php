...
<section class="hero-section">
    <marquee class="marquee" style="--tw:40vw; --ad:2.5s;">
        <p class="brand">KUNSTHAUS KUNSTHAUS KUNSTHAUS KUNSTHAUS</p>
    </marquee>
    <marquee class="marquee-long" style="--tw:40vw; --ad:2.5s;">
        <p class="slogan">不一樣的藝文售票平台 不一樣的藝文售票平台 不一樣的藝文售票平台 不一樣的藝文售票平台</p>
    </marquee>
</section>
