...
<!-- 引入自己的ＣＳＳ -->
<link rel="stylesheet" href="./css/3_B2B-ticket-list-nopay.css">
        ...
        <div class="row ticketbg">
            <div class="title">
                ...
                <div class="ticketbutton d-flex col-xl-6 col-12">
                    ...
                    <button class="modify btn btn-primary">未付款</button>
                    <button class="modify2 btn btn-primary" onclick="location.href='3_B2B-ticket-list-cancel.php'">已取消</button>
                </div>
